# Neo4j Local Setup — Validation Guide

This document describes how to set up, start, and validate the local Neo4j
instance for development. It is the authoritative reference for local Neo4j
...
- [docs/06-engineering/workflow/neo4j-local-setup.md](../06-engineering/workflow/neo4j-local-setup.md)
