...
This section defines how engineering is done in AIGORA.

It provides the rules, workflows, and standards that guide development.
...
- [Engineering Policies](governance/engineering-policies.md)
